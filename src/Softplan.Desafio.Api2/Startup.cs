...
namespace Softplan.Desafio.Api2
{
    public class Startup
    {
        ...
        private const string ProjectTitleName = "Softplan.Desafio.Api2";
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            services.AddSwaggerGen(s =>
            {
                ...
                s.SwaggerDoc($"v{Version}", new Info
                {
                    ...
                    Description = "API Swagger Desafio Softplan API 2",
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(s =>
            {
                s.SwaggerEndpoint($"/swagger/v{Version}/swagger.json", "API 2");
            });
